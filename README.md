...
인원, 예산, 운영 요일만 입력하면 식단을 자동 생성하고,
영양 정보와 실시간 도매 원가를 함께 확인할 수 있는 급식소 관리 웹 서비스
...
| 항목 | 내용 |
|------|------|
| **기간** | (입력 필요) 예: 2025.00 ~ 2025.00 |
| **유형** | 개인 프로젝트 |
| **핵심 기술** | Next.js · TypeScript · Supabase · 식약처 API · KAT Online API |
| **배포 링크** | (입력 필요) 예: https://your-deploy-url.com |
| **발표자료** | (입력 필요) 예: [PDF 링크](link) |
