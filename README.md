...
4. Lovable site에 프롬프트 입력 후 초기 프론트엔드 코드 생성
5. 실행하여 기능 동작 여부 확인 후 GitHub에 푸시

**[주요 개발 단계 — Cursor]**

6. GitHub에서 로컬로 clone
7. Cursor에 프롬프트 입력 후 기능 구현
8. 실행하여 기능 동작 여부 확인
9. 오류 발생 시 문제 상황을 설명하고 수정 요청
10. 정상 작동할 때까지 반복 수정
11. 정상 동작 확인 후 성능 최적화 및 코드 구조 개선 요청
12. 최종 동작 확인 후 배포
